...
class Cargo extends Model
{
    ...
    public static function query()
    {
        ...
        $query= (new static)->newQuery()->select(['ma_cargo.id', 'ma_cargo.nombre', 'ma_cargo.nombre as nombrecargo', 'ma_cargo.descripcion', 'ma_cargo.color', 'id_gerencia','ma_cargo.estado','ma_cargo.area','id_jefatura','id_funcionario']);
        $user = auth()->user();
